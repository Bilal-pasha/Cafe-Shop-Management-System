    ...
    public partial class AdminAddProducts : UserControl
    {
        ...
        private void adminAddProducts_addBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // CHECKING IF THE PRODUCT ID EXISTS ALREADY
                ...
                using (SqlCommand selectPID = new SqlCommand(selectProdID, connect))
                {
                    ...
                    // Use a safe path relative to the application directory
                    string baseDirectory = AppDomain.CurrentDomain.BaseDirectory;
                    string imageDirectory = Path.Combine(baseDirectory, "Product_Directory");
                    ...
                    string imagePath = Path.Combine(imageDirectory, adminAddProducts_id.Text.Trim() + ".jpg");
            ...
            {
                MessageBox.Show("Access denied: " + uex.Message, "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            catch (Exception ex)
            {
